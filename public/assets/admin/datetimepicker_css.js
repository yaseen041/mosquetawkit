...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader = "<table style='background-color:"+CalBgColor+";width:230px;padding:3px;margin:5px auto 5px auto'><tbody>";

	//Table for Month & Year Selector

	vCalHeader += "<tr><td colspan='7'><table border='0' width='230px' cellpadding='3' cellspacing='7'><tr>";
	...
	else if (Cal.Scroller === "ARROW")
	{
		...
		else
		{
			...
			vCalHeader += "<td width='90%' class='calR' style='color:" + YrSelColor + "'>" + Cal.GetMonthName(ShowLongMonth) + " " + Cal.Year + "</td>\n"; //Month and Year
	...
	vCalHeader += "<tr><td colspan=\"7\"><table style='border-spacing:8px;border-collapse:separate;'><tr>";
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime = "<tr><td colspan='7' style=\"text-align:center;\"><table border='0' width='220px' cellpadding='3' cellspacing='5'><tbody><tr><td height='5px' width='" + HourCellWidth + "'>&nbsp;</td>";
