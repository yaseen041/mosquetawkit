...
<head>
	...
	<title>{{ get_section_content('project', 'site_title') }} | Forgot Password</title>
...
<body class="gray-bg">
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			...
			<h3 class="admin_login_st">Forgot Password</h3>
			...
			<form class="m-t" role="form" method="post" action="{{ url('admin/forgot_password') }}">
				@csrf
			...
			<a href="{{ url('admin/login') }}"><small>Back to Login</small></a>
