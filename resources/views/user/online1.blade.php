...
<html lang='SA'>
<head>
<title>Makkah - أوقات الصلاة - Prayer Times | توقيت مكة</title>
...
<link rel='stylesheet' href='/style5.css?c=1738234739'>
<script src='/ayats7.js'></script>
<script src='/admin/wtimes/1-data.js?e=1738234739'></script>
...
var idNow = '';
    ...
    for (var i=0; i < 18; i++)
    {
    document.getElementById('tmV_'+i).style.backgroundImage='url(/themes7/mini/VR-'+i+'.jpg?c=1)';
    document.getElementById('tmH_'+i).style.backgroundImage='url(/themes7/mini/HR-'+i+'.jpg?c=1)';
    }
