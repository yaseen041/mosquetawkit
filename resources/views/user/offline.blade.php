...
<head>
    ...
    <script>
        ...
        JS_PERSO_AUTOX_JOMOA = JS_PERSO_FIXED_JOMOA;
        function dolog(s) {
            console.log(s);
        }
        var JSALLDATA = {
        ...
        if (JS_WCSV_ACTIVE) {
            ...
            var yFile = 'assets/offline/data/' + tmp[0] + '/wtimes-' + JS_CITY_CODE + '.js?e=' + JS_VERSIO; document.write("<script src='" + yFile + "'><\/script>");
        }
    </script>
</head>
<body onload='_cadro();' onresize='_cadro();' class=''>
    ...
    <div id='eMainVERTICAL' class='s003'>
        ...
        <button id='BtnAudio' onclick='forceAudio();'>
            ...
            <div id='eHELPSCREEN' class='cssColorLITE'>
                <div class='cssSET'>
                    <div id='mntopo'><span onclick="SetScroll('eMenuGRP', 0);">&#9650;</span> &nbsp;&nbsp; <span
                        onclick="SetScroll('eMenuGRP', 1);">&#9660;</span>
                    </div>
                </div>
                <div id='eMenuGRP' dir='rtl' class='cssMenuGRP CSS_HAFS'>
                    ...
                    <div class='cssMenuBTN' id='AAA_dev2' onclick="CloseHELP();"><a class='devs' href="#">خيارات في تطوير - Dev.
                    progress</a></div>
                    <div class='cssMenuBTN' id='AAA_dev3' onclick="CloseHELP();"><a class='devs' href="{{ url('contact')}}"
                        target='_blank'>تصحيحات و اقتراحات - Suggestions</a></div>
                        <div class='cssMenuBTN' id='AAA_dev4' onclick="CloseHELP();"><a class='devs' href="{{ url('/') }}"
                            target='_blank'>موقع التحديثات - Updates website</a></div>
                            <div id='mn0'>
                                <div id='mn1'></div>
                            </div>
                        </div>
                                                    ...
                                                    <div><input type='checkbox' id='eCounterEnlarge' class='cssCheckBOX' onchange='SetCounterEnlarge()'> &nbsp;
                                                        ...
                                                        <div><input type='checkbox' id='e1MinCounter' class='cssCheckBOX' onchange='Set1MinCounter()'> &nbsp; <label
                                                            ...
                                                            <div><input type='checkbox' id='eArabicDIGITS' class='cssCheckBOX' onchange='SetArabicDIGITSOnOff()'> &nbsp;
                                                                <label for='eArabicDIGITS' id='W9_ARABICDIGITS'> --- </label></div>
                                                                <!--   hide Iqamat   -->
                                                                <div><input type='checkbox' id='forHOME' class='cssCheckBOX' onchange='Set4HOMEOnOff()'> &nbsp; <label
                                                                    ...
                                                                    <div><input type='checkbox' id='e5BoxesOnly' class='cssCheckBOX' onchange='Set5BoxesOnly()'> &nbsp; <label
                                                                        ...
                                                                        <div><input type='checkbox' id='eVrMiddleNames' class='cssCheckBOX' onchange='SetVrMiddleNames()'> &nbsp;
                                                                            <label for='eVrMiddleNames' id='XX_VR_MIDDLENAMES'> --- </label></div>
                                                                            <div><input type='checkbox' id='eVrNoNEXTNoJMA' class='cssCheckBOX' onchange='SetVrNoNEXTNoJMA()'> &nbsp;
                                                                                <label for='eVrNoNEXTNoJMA' id='XX_VR_NoNEXTNoJMA'> --- </label></div>
                                                                                                ...
                                                                                                <div class='cssTitlesHOLDER'>
                                                                                                    ...
                                                                                                    <div id='scroAZKAR' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                                                        <div><input type='checkbox' id='eAzkarCHECK' class='cssCheckBOX' onchange='SwitchOnOffAZKAR()'> &nbsp;
                                                                                                            <label for='eAzkarCHECK' id='XX_AZKAR_0'> --- </label></div>
                                                                                                                                ...
                                                                                                                                <div class='cssTitlesHOLDER'>
                                                                                                                                    ...
                                                                                                                                    <div id='scroSLIDES' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                                                                                        <div><input type='checkbox' id='eSlidersCHECK' class='cssCheckBOX' onchange='SetOwnSlidersOnOff()'> &nbsp;
                                                                                                                                            <label for='eSlidersCHECK' id='XX_SLIDERS_0'></label></div>
                                                                                                                                            <hr>
                                                                                                                                            <div dir='ltr'>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <div id='scroBLACKS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                                                                                                                                                            <div><input type='checkbox' id='eDimmCHECK' class='cssCheckBOX' onchange='SetDimmOnOff()'> &nbsp; <label
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <div><input type='checkbox' id='eDohaScreenCHECK' class='cssCheckBOX' onchange='DohaSaverOnOff()'> &nbsp;
                                                                                                                                                                                                                    <label for='eDohaScreenCHECK' id='XX_DIMMER_1'></label></div>
                                                                                                                                                                                                                    <div><input type='checkbox' id='eIshaScreenCHECK' class='cssCheckBOX' onchange='IshaSaverOnOff()'> &nbsp;
                                                                                                                                                                                                                        <label for='eIshaScreenCHECK' id='XX_DIMMER_2'></label></div>
        ...
        //--
                                                                                                                                                                                                                                                                                function persoFAJR(obj) {
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    if (JS_FIXED_IQAMATFAJR == "") JS_IQAMA_TIME_OF_FAJR = 10;
                                                                                                                                                                                                                                                                                    GoGloballyFillDATA();
                                                                                                                                                                                                                                                                                    putMinutesInSETTINGS();
        ...
        //--
                                                                                                                                                                                                                                                                                function persoDOHR(obj) {
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    if (JS_FIXED_IQAMATDOHR == "") JS_IQAMA_TIME_OF_DOHR = 10;
                                                                                                                                                                                                                                                                                    GoGloballyFillDATA();
                                                                                                                                                                                                                                                                                    putMinutesInSETTINGS();
        ...
        //--
                                                                                                                                                                                                                                                                                function persoASR(obj) {
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    if (JS_FIXED_IQAMATASR == "") JS_IQAMA_TIME_OF_ASR = 10;
                                                                                                                                                                                                                                                                                    GoGloballyFillDATA();
                                                                                                                                                                                                                                                                                    putMinutesInSETTINGS();
        ...
        //--
                                                                                                                                                                                                                                                                                function persoISHA(obj) {
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    if (JS_FIXED_IQAMATISHA == "") JS_IQAMA_TIME_OF_ISHA = 10;
                                                                                                                                                                                                                                                                                    GoGloballyFillDATA();
        ...
        function ShowRIDEAU() {
            ...
            var JS_WAITBLK = 12000;
            if (JS_DIMM_WHILE_PRAYIN_ACTIVE) {
                if (JSALLDATA.IZIqamaScreen == 0) JS_WAITBLK = 0;
                setTimeout('StartBlackScreenWhilePraying()', JS_WAITBLK);
            }
            ...
            if (JS_DIMM_WHILE_PRAYIN_ACTIVE) setTimeout('animateNoMOBILE()', JS_WAITBLK + 3000);
        }
        ...
        function ProcessAzkarShow() {
            ...
            JS_AZKAR_NEXT++;
            DisplayAzkar();
            setTimeout("ProcessAzkarShow()", JS_MSC_VIEWING);
        ...
        function ProcessSLIDESShow() {
            ...
            if (JS_SLIDES_ForceEND) {
                JS_SLIDES_ForceEND = false;
                return;
            }
            if (JS_SLIDES_NEXT >= JS_SLIDES_DATA.length) {
                JS_SLIDES_NEXT = 0;
                ProcessSLIDESShow();
                return;
            }
            if (sTEXT.indexOf('.jpg') > -1) {
                ...
                DisplaySLIDES();
                setTimeout("ProcessSLIDESShow()", sJS_MSC_VIEWING);
        ...
        function ShowOnePicFIXED5min() {
            ShowZunder2('VR5MIN');
            ShowZunder2('HR5MIN');
            setTimeout("Close5minPIC()", (60000 * 5));
        }
    ...
    function processActiveTUBE(vTube, hx) {
        ...
        setTimeout(selectActiveTUBES, 5000, vTube, hx);
    }
    ...
    function GoGloballyFillDATA() {
        ...
        if ((JSALLDATA.DHRxminASR > 0) && (!JS_WCSV_ACTIVE)) {
            ...
            if (JS_PERSO_FIXED_JOMOA == 'AUTO') {
                JS_PERSO_AUTOX_JOMOA = GoAdjustment(GetNextFriday(3), -(JSALLDATA.DHRxminASR));
            }
        }
        if (JS_TODAY_IS_JOMOA) {
            ...
            if (JS_PERSO_FIXED_JOMOA !== "") {
                if (JS_PERSO_FIXED_JOMOA == 'AUTO') {
                    if (JS_WCSV_ACTIVE) {
                        JS_PERSO_AUTOX_JOMOA = _n13;
                        JS_HReJOMOA2WCSV.innerHTML = '2nd Jomoa : ' + _n14;
                    }
                    else {
                        if (JSALLDATA.DHRxminASR > 0)
                            JS_PERSO_AUTOX_JOMOA = GoAdjustment(_n3, -(JSALLDATA.DHRxminASR));
                        else
                            JS_PERSO_AUTOX_JOMOA = _n2;
                    }
                }
                else {
                    JS_PERSO_AUTOX_JOMOA = JS_PERSO_FIXED_JOMOA;
    ...
    function GetNextFriday(x) {
        ...
        var nextFridayX = "---";
        for (i = 0; i <= 6; i++) {
            JS_TMP.setDate(JS_TMP.getDate() + 1);
            xjjj = JS_TMP.getDay();
            if (xjjj == 5) {
                ...
                if (JS_WCSV_ACTIVE) {
                    ...
                    nextFridayX = jTIMES_NOW[13];
                    JS_HReJOMOA2WCSV.innerHTML = '2nd Jomoa : ' + jTIMES_NOW[14];
                }
                else {
        ...
        if ((JS_DULHIJJA_WORK_DAYS) &&
            ...
            if ((JS_RAMADAN_10_NIGHTS) &&
                    ...
                    for (var i = 0; i < JS_MSGS_DATA.length; i++) {
                        ...
                        if (xARR[0] == "1") {
                            if ((xARR[1] == "DAILY") || (xARR[1] == JS_ADM_TODAY_NAME) || (xARR[1] == JS_ADM_HIJRI_DATE) || (xARR[1] == JS_ADM_10DLHJ)) {
                                ...
                                JS_BTM_WAGON += xARR[2];
                                if (JS_BTM_ONE_MSG == "") JS_BTM_ONE_MSG = xARR[2];
                            }
                        }
                    }
                }
                ...
                function AdminUpdateMarquee() {
                    ...
                    JS_VRMARQ = document.getElementById('VRmarq');
                    JS_HRMARQ = document.getElementById('HRmarq');
        ...
        //----go5BoxesJomoaLogo-
                function go5BoxesJomoaLogo() {
                    ...
                    if (JSALLDATA.IZ5BoxesOnly == 1) {
                        ...
                        jsALNGO.style.borderSpacing = '2.5vw';
                        ...
                        jsALNGO.style.borderSpacing = '0.7vw';
                ...
                setTimeout(uLoadTheCountries, 1500);
