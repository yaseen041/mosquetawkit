...
<head>
    ...
    <script src="{{ asset('assets/offline/ayats.js') }}"></script>
    <script src="{{ asset('assets/offline/countries.js') }}"></script>
    ...
    <!-- Default CSS Styles -->
    <link rel="stylesheet" href="{{ asset('assets/offline/style0.css') }}">

<!-- Dynamically Load CSS Based on JS_FORCED_VERTICAL -->
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var JScssNOW = JS_FORCED_VERTICAL > 0 ? "{{ asset('assets/offline/style2.css') }}" : "{{ asset('assets/offline/style1.css') }}";
...
<script type="text/javascript">
    var JS_LANG_NOW = 'AR';
    var baseUrl = "{{ asset('assets/offline/languages/') }}";
...
JS_VERSIO = new Date().getTime();
         ...
         var yFile = baseUrl + '/assets/offline/data/' + tmp[0] + '/wtimes-' + JS_CITY_CODE + '.js?e=' + JS_VERSIO;
         console.log(yFile);
...
<body onload='_cadro();' onresize='_cadro();' class=''>
    ...
    <div id='eMainVERTICAL' class='s003'>
        ...
        <img id='VR_LOGO' alt='' src="{{ asset('assets/logo.png') }}">
        <div id='eVRDATES'>
            <div id='eVRYOUM'></div>
        ...
        <div id='CLOKO_FULL_VR' onclick='SetFullClockOnOff();'><span id='VR_eFullCLOKO'>--:--</span><span
            id='VR_sssCLOKO'>:</span></div>
            ...
            <div id='eRIDO' class='CSS_BlackSCREEN' onclick='RemoveBlackScreen();'>
                <img id='eMobile' alt='' class='cssNoMOBILE' src="{{ asset('assets/no-mobile.png')}}">
            </div>
            ...
            <div id='VRCONTO' class='SSoff' onclick='CloseFullCONTO();'>
                <span id='sVRCONTO'></span>
                <div id='sVRCloky'></div>
            </div>
            <img id='ePSvr' alt='' src="{{ asset('assets/stats/flags/ps.png') }}">
        </div>
        <div id='eMainHORIZONTAL' class='THRCLASSIC'>
            <div id='eMenuHR' onclick='ShowGlobalHELP();'>&#9776;</div>
            <img id='HR_LOGO' alt='' src="{{ asset('assets/logo.png') }}">
            <div id='HRMILADIHIJRI' onclick='HijriClick();'></div>
            <div id='HRMHJJJ' onclick='HijriClick();'>
                <div id='mhj0'></div>
                <div id='mhj1'></div>
            </div>
            ...
            <div id='CLOKO_MINI_HR' onclick='SetFullClockOnOff();' style="visibility: visible;">
                <div id='HR_eMiniHOUR'>--:--</div>
                <div id='HR_eSECS'>--</div>
                <div id='HR_eAMPM'>--</div>
            </div>
            <div id='CLOKO_FULL_HR' onclick='SetFullClockOnOff();' style="visibility: hidden;">
                ...
                <table id='alongotablo' class='_h6'>
                    <tr>
                        <td id='W333HRtube0'>
                            ...
                            <div class='jnzts'>
                                <div id='jA0' onclick='setJnzMNS(0);'> </div>
                                <div id='jB0' onclick='setJnzPLS(0);'> </div>
                            </div>
                        </td>
                        <td id='W333HRtube1'>
                        ...
                        <td id='W333HRtube2'>
                            ...
                            <div class='HdcA'></div>
                            <div class='jnzts'>
                                <div id='jA2' onclick='setJnzMNS(2);'> </div>
                                <div id='jB2' onclick='setJnzPLS(2);'> </div>
                            </div>
                        </td>
                        <td id='W333HRtube3'>
                            ...
                            <div class='HdcA'></div>
                            <div class='jnzts'>
                                <div id='jA3' onclick='setJnzMNS(3);'> </div>
                                <div id='jB3' onclick='setJnzPLS(3);'> </div>
                            </div>
                        </td>
                        <td id='W333HRtube4' ondblclick='TestCounter();'>
                            ...
                            <div class='HdcA'></div>
                            <div class='jnzts'>
                                <div id='jA4' onclick='setJnzMNS(4);'> </div>
                                <div id='jB4' onclick='setJnzPLS(4);'> </div>
                            </div>
                        </td>
                        <td id='W333HRtube5'>
                            ...
                            <div class='jnzts'>
                                <div id='jA5' onclick='setJnzMNS(5);'> </div>
                                <div id='jB5' onclick='setJnzPLS(5);'> </div>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div id='HReRIDO' class='CSS_BlackSCREEN' onclick='RemoveBlackScreen();'>
                <img id='HReMobile' alt='' class='cssNoMOBILE' src="{{ asset('assets/no-mobile.png') }}">
            </div>
            <div id='HRAZKAR' class='SSoff' onclick='ForceSTOPazkar();'>
                <div id='Hclc' class='jclc'></div>
                <div id='Hmes0'>
                    <div id='Hmes1'></div>
                </div>
            </div>
            <div id='HRSLIDES' class='SSoff' onclick='ForceSTOPSLIDES();'>
                <div id='sHclc' class='jclc'></div>
                <div id='sHmes0'>
                    <div id='sHmes1'></div>
                </div>
            </div>
            ...
            <div id='HRCONTO' class='SSoff' onclick='CloseFullCONTO();'>
                <span id='sHRCONTO'></span>
                <div id='sHRCloky'></div>
                <div id='ELMOBIL2'><img src="{{ asset('assets/no-mobile.png')}}"></div>
            </div>
            <img id='ePShr' alt='' src="{{ asset('assets/stats/flags/ps.png')}}">
        </div>
        <button id='BtnAudio' onclick='forceAudio();'>
            Azan Voice is Activated in Settings
            <br>
            Click Here To Enable Sounds in Browser
        </button>
        ...
        <div id='eHELPSCREEN' class='cssColorLITE'>
            <div class='cssSET'>
                <div id='mntopo'>
                    <span onclick="SetScroll('eMenuGRP', 0);">&#9650;</span>
                    &nbsp;&nbsp;
                    <span onclick="SetScroll('eMenuGRP', 1);">&#9660;</span>
                </div>
            </div>
            <div id='eMenuGRP' dir='rtl' class='cssMenuGRP CSS_HAFS'>
                <div id='LangsDIV'>
                    <img id='ePS' alt='' src="{{ asset('assets/stats/flags/ps.png')}}">&nbsp;&nbsp;&nbsp;
                ...
                <div class='cssMenuBTN' id='AAA_dev2' onclick="CloseHELP();"><a class='devs'
                    href='https://support.tawkit.net/showthread.php?tid=11' target='_blank'>خيارات في تطوير - Dev.
                progress</a>
            </div>
            <div class='cssMenuBTN' id='AAA_dev3' onclick="CloseHELP();">
                <a class='devs' href='https://www.tawkit.net/contact/' target='_blank'>تصحيحات و اقتراحات -
                Suggestions</a>
            </div>
            <div class='cssMenuBTN' id='AAA_dev4' onclick="CloseHELP();">
                <a class='devs' href='https://www.tawkit.net/' target='_blank'>موقع التحديثات - Updates website</a>
            </div>
            <div id='mn0'>
                <div id='mn1'></div>
            </div>
    ...
    <div id='e_ABOUT' class='cssModelSettingsWINDOW cssColorLITE'>
        <div class='cssTitlesHOLDER'>
            ...
            <div class='cssWindowCLOSE'><span onclick="SetScroll('scroABOUT', 0);">&#9650;</span> &nbsp; <span
                onclick="SetScroll('scroABOUT', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                onclick='closeThis(this.parentNode);'>&#10006;</span></div>
            </div>
        ...
        <div id='e_OPTIONS' class='cssModelSettingsWINDOW cssColorLITE'>
            <div class='cssTitlesHOLDER'>
                <div class='cssWindowTITLE'></div>
                <div class='cssWindowCLOSE'><span class='hnd' onclick="SetScroll('scroOPTIONS', 0);">&#9650;</span> &nbsp;
                    <span class='hnd' onclick="SetScroll('scroOPTIONS', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                    onclick='closeThis(this.parentNode);'>&#10006;</span>
                </div>
            </div>
            <div id='scroOPTIONS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                ...
                <hr>
                <!--   24H ON-OFF   -->
                <div><input type='checkbox' id='e24CHECK' class='cssCheckBOX' onchange='Set24OnOff()'> &nbsp; <label
                    for='e24CHECK' id='XX_OPTION_0'> </label></div>
                    <!--    Set Zeros in AMPM -->
                    <div><input type='checkbox' id='eZerosAMPM' class='cssCheckBOX' onchange='SetZerosAMPM()'> &nbsp; <label
                        for='eZerosAMPM' id='XX_ZEROS_AMPM'> --- </label></div>
                        <!--   FULL CLOCK   -->
                        <div><input type='checkbox' id='eFullClockCHECK' class='cssCheckBOX' onchange='SetFullClockOnOff()'> &nbsp;
                            <label for='eFullClockCHECK'><span id='XX_OPTION_1'>---</span> "00:00:00" </label>
                        </div>
                        <!--   DIM PAST TIMES   -->
                        <div><input type='checkbox' id='ePastDimerCHECK' class='cssCheckBOX' onchange='SetPastDimerOnOff()'> &nbsp;
                            <label for='ePastDimerCHECK' id='XX_OPTION_2'>---</label>
                        </div>
                        <!--   IQAMA FULLE TIME   -->
                        <div><input type='checkbox' id='eIQAMAasHOUR' class='cssCheckBOX' onchange='SetIqamaFullTimes()'> &nbsp;
                            <label for='eIQAMAasHOUR' id='XX_IQAMAASHOUR'>---</label>
                        </div>
                        <!--    COUNTDOWN OnOff   -->
                        <div><input type='checkbox' id='eCOUNTDOWNOnOff' class='cssCheckBOX' onchange='SetCOUNTDOWNOnOff()'> &nbsp;
                            <label for='eCOUNTDOWNOnOff' id='W9_eCOUNTDOWNOnOff'>---</label>
                        </div>
                        <div><input type='checkbox' id='eCounterEnlarge' class='cssCheckBOX' onchange='SetCounterEnlarge()'> &nbsp;
                            <label for='eCounterEnlarge' id='XX_ENLARGE'>---</label>
                        </div>
                        <div><input type='checkbox' id='e1MinCounter' class='cssCheckBOX' onchange='Set1MinCounter()'> &nbsp; <label
                            for='e1MinCounter' id='XX_1MIN_COUNTER'>---</label></div>
                            <!--   ARABIC DIGITS   -->
                            <div><input type='checkbox' id='eArabicDIGITS' class='cssCheckBOX' onchange='SetArabicDIGITSOnOff()'> &nbsp;
                                <label for='eArabicDIGITS' id='W9_ARABICDIGITS'> --- </label>
                            </div>
                            <!--   hide Iqamat   -->
                            <div><input type='checkbox' id='forHOME' class='cssCheckBOX' onchange='Set4HOMEOnOff()'> &nbsp; <label
                                for='forHOME' id='XX_HIDE_IQAMAT'> --- </label></div>
                                <!--    HR 5 BOXES ONLY  -->
                                <div><input type='checkbox' id='e5BoxesOnly' class='cssCheckBOX' onchange='Set5BoxesOnly()'> &nbsp; <label
                                    for='e5BoxesOnly' id='XX_5BOXES_ONLY'> --- </label></div>
                                    <div><input type='checkbox' id='eVrMiddleNames' class='cssCheckBOX' onchange='SetVrMiddleNames()'> &nbsp;
                                        <label for='eVrMiddleNames' id='XX_VR_MIDDLENAMES'> --- </label>
                                    </div>
                                    <div><input type='checkbox' id='eVrNoNEXTNoJMA' class='cssCheckBOX' onchange='SetVrNoNEXTNoJMA()'> &nbsp;
                                        <label for='eVrNoNEXTNoJMA' id='XX_VR_NoNEXTNoJMA'> --- </label>
                                    </div>
                                    <div><input type='checkbox' id='eIqamaScr' class='cssCheckBOX' onchange='SetIqamaScreen()'> &nbsp; <label
                                        for='eIqamaScr' id='XX_IQAMASCREEN'> --- </label></div>
                                        <hr>
                                        <div>Change months names | تغيير أسماء الشهور</div>
                                        <input type='radio' onclick="goMonthsZZ(0);" name='RZZ1' id='ZZZ0'><label id='jZ0' for='ZZZ0'>بدون تغيير |
                                        Default </label><br>
                                        ...
                                        <!--  MP3   -->
                                        <hr>
                                        <div><input type='checkbox' id='eVoiceCHECK' class='cssCheckBOX' onchange='SetAudioVoiceOnOff()'> &nbsp;
                                            <label for='eVoiceCHECK' id='XX_ADJUST_2'> --- </label>
                                        </div>
                                        <div><input type='checkbox' id='eShortAZAN' class='cssCheckBOX' onchange='SetShortAZANOnOff()'> &nbsp;
                                            <label for='eShortAZAN' id='XX_eShortAZAN'> --- </label>
                                        </div>
                                        <div><input type='checkbox' id='eShortIQAMA' class='cssCheckBOX' onchange='SetShortIQAMAOnOff()'> &nbsp;
                                            <label for='eShortIQAMA' id='XX_eShortIQAMA'> --- </label>
                                        </div>
                                        <!--  FONTS   -->
                                        <hr>
                                        ...
                                        <table id='xtFonts'>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type='radio' onclick="goFontTHIS('Amiri');" name='Rfon1' id='Amiri'><label for='Amiri'>
                                                    AMIRI</label><br>
                                                    <input type='radio' onclick="goFontTHIS('Andalus');" name='Rfon1' id='Andalus'><label
                                                    for='Andalus'> ANDALUS</label><br>
                                                    <input type='radio' onclick="goFontTHIS('KSA');" name='Rfon1' id='KSA'><label for='KSA'>
                                                    KSA</label><br>
                                                    <input type='radio' onclick="goFontTHIS('Taha');" name='Rfon1' id='Taha'><label for='Taha'>
                                                    TAHA</label><br>
                                                    <input type='radio' onclick="goFontTHIS('STC');" name='Rfon1' id='STC'><label for='STC'>
                                                    STC</label><br>
                                                    <input type='radio' onclick="goFontTHIS('FODA');" name='Rfon1' id='FODA'><label for='FODA'>
                                                    FODA</label><br>
                                                    <input type='radio' onclick="goFontTHIS('MOLHIM');" name='Rfon1' id='MOLHIM'><label
                                                    for='MOLHIM'> MOLHIM</label><br>
                                                </td>
                                                <td>
                                                    <input type='radio' onclick="goFontTIMES('FreeSans');" name='Rfon2' id='TIMES-FreeSans'><label
                                                    for='TIMES-FreeSans'> FreeSANS</label><br>
                                                    <input type='radio' onclick="goFontTIMES('TTKP');" name='Rfon2' id='TIMES-TTKP'><label
                                                    for='TIMES-TTKP'> TTKP</label><br>
                                                    <input type='radio' onclick="goFontTIMES('FONTO');" name='Rfon2' id='TIMES-FONTO'><label
                                                    for='TIMES-FONTO'> FONTO</label><br>
                                                    <input type='radio' onclick="goFontTIMES('STC');" name='Rfon2' id='TIMES-STC'><label
                                                    for='TIMES-STC'> STC</label><br>
                                                </td>
                                                <td>
                                                    <input type='radio' onclick="goFontCLOKEN('FreeSans');" name='Rfon3' id='CLOCK-FreeSans'><label
                                                    for='CLOCK-FreeSans'> FreeSANS</label><br>
                                                    <input type='radio' onclick="goFontCLOKEN('TTKP');" name='Rfon3' id='CLOCK-TTKP'><label
                                                    for='CLOCK-TTKP'> TTKP</label><br>
                                                    <input type='radio' onclick="goFontCLOKEN('FONTO');" name='Rfon3' id='CLOCK-FONTO'><label
                                                    for='CLOCK-FONTO'> FONTO</label><br>
                                                    <input type='radio' onclick="goFontCLOKEN('STC');" name='Rfon3' id='CLOCK-STC'><label
                                                    for='CLOCK-FONTO'> STC</label><br>
                                                </td>
                                                <td>
                                                    <input type='radio' onclick="goFontAZKAR('Amiri');" name='Rfon4' id='AZKAR-Amiri'><label
                                                    for='AZKAR-Amiri'> AMIRI</label><br>
                                                    <input type='radio' onclick="goFontAZKAR('KSA');" name='Rfon4' id='AZKAR-KSA'><label
                                                    for='AZKAR-KSA'> KSA</label><br>
                                                    <input type='radio' onclick="goFontAZKAR('Taha');" name='Rfon4' id='AZKAR-Taha'><label
                                                    for='AZKAR-Taha'> TAHA</label><br>
                                                    <input type='radio' onclick="goFontAZKAR('SULTAN');" name='Rfon4' id='AZKAR-SULTAN'><label
                                                    for='AZKAR-SULTAN'> SULTAN</label><br>
                                                    <input type='radio' onclick="goFontAZKAR('FODA');" name='Rfon4' id='AZKAR-FODA'><label
                                                    for='AZKAR-FODA'> FODA</label><br>
                                                    <input type='radio' onclick="goFontAZKAR('MOLHIM');" name='Rfon4' id='AZKAR-MOLHIM'><label
                                                    for='AZKAR-MOLHIM'> MOLHIM</label><br>
                                                </td>
                                            </tr>
                                        </table>
                                        <br>
                                        <!--  JANAZAT COUNT   -->
                                        <hr>
                                        <div><input type='checkbox' id='eJanazat' class='cssCheckBOX' onchange='SetJanazatOnOff()'> &nbsp; <label
                                            for='eJanazat' id='XX_JANAZAT_COUNTER'> --- </label></div>
                                    ...
                                    <div id='e_AZKAR' class='cssModelSettingsWINDOW cssColorLITE'>
                                        <div class='cssTitlesHOLDER'>
                                            <div class='cssWindowTITLE'></div>
                                            <div class='cssWindowCLOSE'><span onclick="SetScroll('scroAZKAR', 0);">&#9650;</span> &nbsp; <span
                                                onclick="SetScroll('scroAZKAR', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                            </div>
                                            <div id='scroAZKAR' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                <div><input type='checkbox' id='eAzkarCHECK' class='cssCheckBOX' onchange='SwitchOnOffAZKAR()'> &nbsp;
                                                    <label for='eAzkarCHECK' id='XX_AZKAR_0'> --- </label>
                                                </div>
                                                <div><input type='checkbox' id='eAzkar5minCHECK' class='cssCheckBOX' onchange='SetOnePictureFixed5min()'>
                                                    &nbsp; <label for='eAzkar5minCHECK' id='XX_AZKAR_4'> --- </label></div>
                                                    <hr>
                                                    <div dir='ltr'>
                                            ...
                                            <div id='e_AZKAR_SBH_MSA' class='cssModelSettingsWINDOW cssColorLITE'>
                                                <div class='cssTitlesHOLDER'>
                                                    <div class='cssWindowTITLE'></div>
                                                    <div class='cssWindowCLOSE'><span onclick="SetScroll('scroAZKAR', 0);">&#9650;</span> &nbsp; <span
                                                        onclick="SetScroll('scroSBH_MSA', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                        onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                                    </div>
                                                    <div id='scroSBH_MSA' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                        <div><input type='checkbox' id='eAzkarSBHCHECK' class='cssCheckBOX' onchange='OnOffAzkarSBH()'> &nbsp;
                                                            <label for='eAzkarSBHCHECK' id='XX_AZKAR_SABAH'> --- </label>
                                                        </div>
                                                        <div><input type='checkbox' id='eAzkarASRCHECK' class='cssCheckBOX' onchange='OnOffAzkarASR()'> &nbsp;
                                                            <label for='eAzkarASRCHECK' id='XX_AZKAR_ASR'> --- </label>
                                                        </div>
                                                        <div><input type='checkbox' id='eAzkarMGBCHECK' class='cssCheckBOX' onchange='OnOffAzkarMGB()'> &nbsp;
                                                            <label for='eAzkarMGBCHECK' id='XX_AZKAR_MAGRIB'> --- </label>
                                                        </div>
                                                        <div><input type='checkbox' id='eAzkarISHCHECK' class='cssCheckBOX' onchange='OnOffAzkarISH()'> &nbsp;
                                                            <label for='eAzkarISHCHECK' id='XX_AZKAR_ISHA'> --- </label>
                                                        </div>
                                                        <hr>
                                                        <div dir='ltr'>
                                                ...
                                                <div id='e_SLIDERS' class='cssModelSettingsWINDOW cssColorLITE'>
                                                    <div class='cssTitlesHOLDER'>
                                                        <div class='cssWindowTITLE'></div>
                                                        <div class='cssWindowCLOSE'><span onclick="SetScroll('scroSLIDES', 0);">&#9650;</span> &nbsp; <span
                                                            onclick="SetScroll('scroSLIDES', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                            onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                                        </div>
                                                        <div id='scroSLIDES' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                            <div><input type='checkbox' id='eSlidersCHECK' class='cssCheckBOX' onchange='SetOwnSlidersOnOff()'> &nbsp;
                                                                <label for='eSlidersCHECK' id='XX_SLIDERS_0'></label>
                                                            </div>
                                                            <hr>
                                                            <div dir='ltr'>
                                                    ...
                                                    <div id='e_ADJUSTMENTS' class='cssModelSettingsWINDOW cssColorLITE'>
                                                        <div class='cssTitlesHOLDER'>
                                                            <div class='cssWindowTITLE'></div>
                                                            <div class='cssWindowCLOSE'><span onclick="SetScroll('scroADJUSTMENTS', 0);">&#9650;</span> &nbsp; <span
                                                                onclick="SetScroll('scroADJUSTMENTS', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                                onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                                            </div>
                                                            <div id='scroADJUSTMENTS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                <!--   Ramadan30  -->
                                                                <div><input type='checkbox' id='eRamadan30CHECK' class='cssCheckBOX' onchange='SetRamadan30MinOnOff()'>
                                                                    &nbsp; <label for='eRamadan30CHECK' id='XX_ADJUST_3'> --- </label></div>
                                                                    <!--  Summer   -->
                                                                    <div><input type='checkbox' id='eSummerCHECK' class='cssCheckBOX' onchange='SetSummerOnOff()'> &nbsp; <label
                                                                        for='eSummerCHECK' id='XX_SUMMERTIME'> --- </label></div>
                                                                        <!--  MoreHour   -->
                                                                        <div><input type='checkbox' id='eMoreHourCHECK' class='cssCheckBOX' onchange='Set1MoreHOUR()'> &nbsp; <label
                                                                            for='eMoreHourCHECK' id='XX_1MOREHOUR'> --- </label></div>
                                                                            <!--   LessHour  -->
                                                                            <div><input type='checkbox' id='eLessHourCHECK' class='cssCheckBOX' onchange='Set1LessHOUR()'> &nbsp; <label
                                                                                for='eLessHourCHECK' id='XX_1LESSHOUR'> --- </label></div>
                                                                                ...
                                                                                <table id='tablePrayADJ'>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td><button class='cccADJUSTER' onclick="goAZANminus('FAJR')">-</button>&nbsp;<button
                                                                                            class='cccADJUSTER' onclick="goAZANcplus('FAJR')">+</button></td>
                                                                                            <td><button class='cccADJUSTER' onclick="goAZANminus('SHRQ')">-</button>&nbsp;<button
                                                                                                class='cccADJUSTER' onclick="goAZANcplus('SHRQ')">+</button></td>
                                                                                                <td><button class='cccADJUSTER' onclick="goAZANminus('DOHR')">-</button>&nbsp;<button
                                                                                                    class='cccADJUSTER' onclick="goAZANcplus('DOHR')">+</button></td>
                                                                                                    <td><button class='cccADJUSTER' onclick="goAZANminus('ASR')">-</button>&nbsp;<button
                                                                                                        class='cccADJUSTER' onclick="goAZANcplus('ASR')">+</button></td>
                                                                                                        <td><button class='cccADJUSTER' onclick="goAZANminus('MAGHRIB')">-</button>&nbsp;<button
                                                                                                            class='cccADJUSTER' onclick="goAZANcplus('MAGHRIB')">+</button></td>
                                                                                                            <td><button class='cccADJUSTER' onclick="goAZANminus('ISHA')">-</button>&nbsp;<button
                                                                                                                class='cccADJUSTER' onclick="goAZANcplus('ISHA')">+</button></td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                        <!--  IQAMA ADJUSTEMENTS   -->
                                                                                                        <hr>
                                                                                                        ...
                                                                                                        <table id='tableIQAMATS'>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAminus('FAJR')">-</button>
                                                                                                                </td>
                                                                                                                <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAcplus('FAJR')">+</button>
                                                                                                                </td>
                                                                                                                <td align='left'>
                                                                                                                    <select id='pFAJR' onchange='persoFAJR(this);'>
                                                                                                                        <option value=''>---</option>
                                                                                                                        <option value='03:00'>Fixed 03:00</option>
                                                                                                                        <option value='03:05'>Fixed 03:05</option>
                                                                                                                        <option value='03:10'>Fixed 03:10</option>
                                                                                                                        <option value='03:15'>Fixed 03:15</option>
                                                                                                                        <option value='03:20'>Fixed 03:20</option>
                                                                                                                        <option value='03:25'>Fixed 03:25</option>
                                                                                                                        <option value='03:30'>Fixed 03:30</option>
                                                                                                                        <option value='03:35'>Fixed 03:35</option>
                                                                                                                        <option value='03:40'>Fixed 03:40</option>
                                                                                                                        <option value='03:45'>Fixed 03:45</option>
                                                                                                                        <option value='03:50'>Fixed 03:50</option>
                                                                                                                        <option value='03:55'>Fixed 03:55</option>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAminus('ASR')">-</button>
                                                                                                                </td>
                                                                                                                <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAcplus('ASR')">+</button>
                                                                                                                </td>
                                                                                                                <td align='left'>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width='10%' align='left'><button class='cccADJUSTER'
                                                                                                                    onclick="goIQAMAminus('MAGHRIB')">-</button></td>
                                                                                                                    <td width='10%' align='left'><button class='cccADJUSTER'
                                                                                                                        onclick="goIQAMAcplus('MAGHRIB')">+</button></td>
                                                                                                                        <td align='left'>.</td>
                                                                                                                    </tr>
                                                                                                                    <!--   ISHA SETTINGS  -->
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAminus('ISHA')">-</button>
                                                                                                                        </td>
                                                                                                                        <td width='10%' align='left'><button class='cccADJUSTER' onclick="goIQAMAcplus('ISHA')">+</button>
                                                                                                                        </td>
                                                                                                                        <td align='left'>
                                                                                                                ...
                                                                                                                <table align='center' cellpadding='5' width='100%'>
                                                                                                                    <tr>
                                                                                                                        <td width='70%' valign='top'>
                                                                                                                            ...
                                                                                                                            <div><input type='checkbox' id='eJomoa01CHECK' class='cssCheckBOX' onchange='SetJOMOAonOff()'>
                                                                                                                                &nbsp; <label for='eJomoa01CHECK' id='XX_JOMOA_SHOW'></label></div>
                                                                                                                                <div><input type='checkbox' id='eJomoaLogoCHECK' class='cssCheckBOX'
                                                                                                                                    onchange='SetJomoaLogoCHECK()'> &nbsp; <label for='eJomoaLogoCHECK'
                                                                                                                                    id='XX_JOMOA_INLOGO'></label></div>
                                                                                                                                </td>
                                                                                                                        ...
                                                                                                                        <hr>
                                                                                                                        <div onclick='doDHRxminASR();'><span id='XX_DOHR_XMIN_ASR'></span> <span id='DHRxminASR' class='wt'>0</span>
                                                                                                                        </div>
                                                                                                                        <hr>
                                                                                                                        <br>
                                                                                                                        <br><br><br>
                                                                                                                ...
                                                                                                                <div id='e_BLACKSCREEN' class='cssModelSettingsWINDOW cssColorLITE'>
                                                                                                                    <div class='cssTitlesHOLDER'>
                                                                                                                        <div class='cssWindowTITLE'></div>
                                                                                                                        <div class='cssWindowCLOSE'><span onclick="SetScroll('scroBLACKS', 0);">&#9650;</span> &nbsp; <span
                                                                                                                            onclick="SetScroll('scroBLACKS', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                                                                                            onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                                                                                                        </div>
                                                                                                                        <div id='scroBLACKS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                                                                            <!--   DIMM SCREEN ON-OFF   -->
                                                                                                                            <div><input type='checkbox' id='eDimmCHECK' class='cssCheckBOX' onchange='SetDimmOnOff()'> &nbsp; <label
                                                                                                                                for='eDimmCHECK' id='XX_DIMMER_0'></label></div>
                                                                                                                                <div><input type='checkbox' id='eDohaScreenCHECK' class='cssCheckBOX' onchange='DohaSaverOnOff()'> &nbsp;
                                                                                                                                    <label for='eDohaScreenCHECK' id='XX_DIMMER_1'></label>
                                                                                                                                </div>
                                                                                                                                <div><input type='checkbox' id='eIshaScreenCHECK' class='cssCheckBOX' onchange='IshaSaverOnOff()'> &nbsp;
                                                                                                                                    <label for='eIshaScreenCHECK' id='XX_DIMMER_2'></label>
                                                                                                                                </div>
                                                                                                                                <!--   JOMOA_DIM_SETTINGS  -->
                                                                                                                                ...
                                                                                                                                <table align='center' cellpadding='5' width='80%' class='cccTBL1'>
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                            onclick="goDURATIONminus('FAJR')">-</button></td>
                                                                                                                                            <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                onclick="goDURATIONcplus('FAJR')">+</button></td>
                                                                                                                                            </tr>
                                                                                                                                        </table>
                                                                                                                                        <!--   DOHR DURATION  -->
                                                                                                                                        <table align='center' cellpadding='5' width='80%' class='cccTBL1'>
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                    onclick="goDURATIONminus('DOHR')">-</button></td>
                                                                                                                                                    <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                        onclick="goDURATIONcplus('DOHR')">+</button></td>
                                                                                                                                                    </tr>
                                                                                                                                                </table>
                                                                                                                                                <!--   ASR DURATION  -->
                                                                                                                                                <table align='center' cellpadding='5' width='80%' class='cccTBL1'>
                                                                                                                                                    <tr>
                                                                                                                                                        ...
                                                                                                                                                        <td width='15%' align='left'><button class='cccADJUSTER' onclick="goDURATIONminus('ASR')">-</button>
                                                                                                                                                        </td>
                                                                                                                                                        <td width='15%' align='left'><button class='cccADJUSTER' onclick="goDURATIONcplus('ASR')">+</button>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                                                                                                                </table>
                                                                                                                                                <!--   MAGHRIB DURATION  -->
                                                                                                                                                <table align='center' cellpadding='5' width='80%' class='cccTBL1'>
                                                                                                                                                    <tr>
                                                                                                                                                        ...
                                                                                                                                                        <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                            onclick="goDURATIONminus('MAGHRIB')">-</button></td>
                                                                                                                                                            <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                                onclick="goDURATIONcplus('MAGHRIB')">+</button></td>
                                                                                                                                                            </tr>
                                                                                                                                                        </table>
                                                                                                                                                        <!--   ISHA DURATION  -->
                                                                                                                                                        <table align='center' cellpadding='5' width='80%' class='cccTBL1'>
                                                                                                                                                            <tr>
                                                                                                                                                                ...
                                                                                                                                                                <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                                    onclick="goDURATIONminus('ISHA')">-</button></td>
                                                                                                                                                                    <td width='15%' align='left'><button class='cccADJUSTER'
                                                                                                                                                                        onclick="goDURATIONcplus('ISHA')">+</button></td>
                                                                                                                                                                    </tr>
                                                                                                                                                                </table>
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                        ...
                                                                                                                                                        <div id='e_LOCALISATION' class='cssModelSettingsWINDOW cssColorLITE'>
                                                                                                                                                            <div class='cssTitlesHOLDER'>
                                                                                                                                                                <div class='cssWindowTITLE'></div>
                                                                                                                                                                <div class='cssWindowCLOSE'><span onclick="SetScroll('scroLOCATION', 0);">&#9650;</span> &nbsp; <span
                                                                                                                                                                    onclick="SetScroll('scroLOCATION', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                                                                                                                                    onclick="closeThis(this.parentNode);">&#10006;</span></div>
                                                                                                                                                                </div>
                                                                                                                                                                            ...
                                                                                                                                                                            <tr>
                                                                                                                                                                                <td width='100%' valign='top' class='otoHIDN'>
                                                                                                                                                                                    <div style='padding:3%; color:white;'>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <a href='https://www.tawkit.net/wtimes/'
                                                                                                                                                                                        target='_blank'>https://www.tawkit.net/wtimes</a>
                                                                                                                                                                                    </div>
                                                                                                                                                                                </td>
                                                                                                                                                                            </tr>
                                                                                                                                                                        </table>
                                                                                                                                                            ...
                                                                                                                                                            <div id='e_ADMINMSGS' class='cssModelSettingsWINDOW cssColorLITE'>
                                                                                                                                                                <div class='cssTitlesHOLDER'>
                                                                                                                                                                    <div class='cssWindowTITLE'></div>
                                                                                                                                                                    <div class='cssWindowCLOSE'><span onclick="SetScroll('scroADMIN_MSGS', 0);">&#9650;</span> &nbsp; <span
                                                                                                                                                                        onclick="SetScroll('scroADMIN_MSGS', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                                                                                                                                        onclick="closeThis(this.parentNode);">&#10006;</span></div>
                                                                                                                                                                    </div>
                                                                                                                                                                    <div id='scroADMIN_MSGS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
                                                                                                                                                                        ...
                                                                                                                                                                        <div><input type='checkbox' id='eScrollableMSG' class='cssCheckBOX' onchange='SetScrollableMSGOnOff()'>
                                                                                                                                                                            &nbsp; <label for='eScrollableMSG' id='XX_SCROLLABLE_MSG'> --- </label></div>
                                                                                                                                                                    ...
                                                                                                                                                                    <div id='e_METEO' class='cssModelSettingsWINDOW cssColorLITE'>
                                                                                                                                                                        <div class='cssTitlesHOLDER'>
                                                                                                                                                                            <div class='cssWindowTITLE'></div>
                                                                                                                                                                            <div class='cssWindowCLOSE'><span onclick="SetScroll('scroMETEO', 0);">&#9650;</span> &nbsp; <span
                                                                                                                                                                                onclick="SetScroll('scroMETEO', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
                                                                                                                                                                                onclick='closeThis(this.parentNode);'>&#10006;</span></div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div id='scroMETEO' class='cssSettingsDATA'>
                                                                                                                                                                                <div><input type='checkbox' id='MeteoCHECK' class='cssCheckBOX' onchange='SetMeteoOnOff()'> &nbsp; <label
                                                                                                                                                                                    for='MeteoCHECK' id='xxMETEO'></label></div>
                                                                                                                                                                                    <div><input type='checkbox' id='eMtoPRYRS' class='cssCheckBOX' onchange='SetMtoPRYRS()'> &nbsp; <label
                                                                                                                                                                                        for='eMtoPRYRS' id='XX_METEOPRYRS'></label></div>
                                                                                                                                                                                        <center>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <br>
                                                                                                                                                                                        <div align='center' class='minigray'>7 DAYS WEATHER FORECASTS.<br>Auto-updates when application starts and
                                                                                                                                                                                            at midnight.<br>This service needs Internet at least once a week.<br><br>Service by : Open-Meteo.com
                                                                                                                                                                                        </div>
                                                                                                                                                                                        <br><br><br>
                                                                                                                                                                                    </div>
                                                                                                                                                                                </div>
    ...
    JS_NowTHEME = 'themes/HR-' + JS_ACTIVE_BG;
...
GoGloballyFillDATA();
        ...
        function getCITY(obj) {
            ...
            var yFile = baseUrl + 'assets/offline/data/' + tmp[0] + '/wtimes-' + JS_CITY_CODE + '.js';
...
function jxCountryCHANGE(obj) {
    var eee_CODE = obj.options[obj.selectedIndex].value;
            ...
            var tempjxFile = "data/" + eee_CODE + "/" + eee_CODE + ".js" + JS_VERSIO;
...
for (var i = 0; i < tempAzkarARR.length; i++) {
    if (tempAzkarARR[i] !== "") {
        ...
        if (ccc.indexOf('-----') > -1) { if (www !== "") JS_AZKAR_PRIMARY.push(www); www = ""; }
        else { www += ccc + "<br>"; }
    }
}
            //---------------- SABAH
...
for (var i = 0; i < tempAzkarARR.length; i++) {
    if (tempAzkarARR[i] !== "") {
        var ccc = tempAzkarARR[i];
        if (ccc.indexOf('-----') > -1) { if (www !== "") JS_AZKAR_SABAH.push(www); www = ""; }
        else { www += ccc + "<br>"; }
    }
}
            //---------------- MASAA
...
for (var i = 0; i < tempAzkarARR.length; i++) {
    if (tempAzkarARR[i] !== "") {
        var ccc = tempAzkarARR[i];
        if (ccc.indexOf('-----') > -1) { if (www !== "") JS_AZKAR_MASAA.push(www); www = ""; }
        else { www += ccc + "<br>"; }
    }
}
}
...
if (JS_nowMNTS == (JS_IQAMA_TIME_OF_FAJR + _fjr)) { Play_IqamaTit(); }
            //--------------- DOHA CAME ---------------
if (JS_nowMNTS == (JS_IQAMA_TIME_OF_SHRQ + _shrq)) { Play_DohaTit(); }
            //--------------- IQAMA_THUHR ---------------
...
if (hhhhh >= 12) {
    if (hhhhh > 12) hhhhh = hhhhh - 12;
            ...
            if (JSALLDATA.IZaddZerosAMPM == 1) { if (finalOut.length < 5) finalOut = '0' + finalOut; }
return finalOut;
}
        //-----------------------------------------------------------------------------------
    ...
    HideZunder('HReMESSAGE1');
            ...
            else  // USER MSG ACTIVE
            {
                if (JSALLDATA.IZmarquee == 1) {
                    ...
                    HideZunder('HReMESSAGE0');
                    if (izArabic(JS_BTM_WAGON)) { JS_VRMARQ.direction = 'right'; JS_HRMARQ.direction = 'right'; }
                        else { JS_VRMARQ.direction = 'left'; JS_HRMARQ.direction = 'left'; }
                    }
                    else {
                        HideZunder('VReMESSAGE1');
                        HideZunder('HReMESSAGE1');
...
function setMenuIcon(obj, iko) {
    ...
    obj.style.background = baseUrl+'/images/icons/' + iko + ')';
...
if (idx > -1) {
    ...
    JS_HRimgMETEO.src = 'images/meteo/0.png';
    JS_HRmtoHHH.innerHTML = '-';
    JS_VRmtoHHH.innerHTML = '-';
}
            //--------------- ADD METEO TO EACH PRAYER
if (JSALLDATA.IZMtoPRYRS == 1) {
    for (var i = 0; i < 6; i++) {
        ...
        if (idx > -1) {
            ...
            slxOH.title = icx;
            slxOH.style.background = "url(./images/" + imgc + ") no-repeat left bottom";
