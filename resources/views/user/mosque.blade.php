...
<head>
	<title>{{$mosque->city}} - أوقات الصلاة - Prayer Times | {{$mosque->app_name}}</title>
	<meta name='Description'
	content="{{$mosque->app_name}} | Awkat Salat | Algeria . {{$mosque->city}} Prayer Times | أوقات الصلاة | Horaires de prière" />
	...
	<script src="{{ asset('uploads/wtimes/' . $mosque->unique_id . '-data.js') }}"></script>
	...
	<script type='text/javascript'>
		var JS_TAWKIT_ONLINE_VERSION = 111;
		var JS_NET_ADRESS_VERSION = "{{ get_section_content('project', 'site_title') }}";
		var JS_cCODE = '{{ $mosque->country_code}}';
		var JS_LOCATION_NOW = "{{ $mosque->city}}, {{ $mosque->country_code}}";
		var JS_LOGS_ENABLED = false;
		var JS_SUMMER_ADD1HOUR = '{{$mosque->summer_hour}}';
		var JS_RAMADAN_30MIN_ACTIVE = '{{$mosque->increase_isha_ramadan}}';
		var JS_LESS1HOUR_IN_RAMADAN = '{{$mosque->reduce_isha_ramadan}}';
...
<body onload='_cadro();' onresize='_cadro();'>
	...
	<div id='eMainVERTICAL'>
		...
		<img src="{{ asset($mosque->logo ? 'uploads/mosque_logos/' . $mosque->logo : 'assets/logo.png') }}" id="VR_LOGO" alt="app-logo" class="VR_LOGO" />
		...
		<img alt='تحيا فلسطين' src="{{ asset('assets/stats/flags/ps.png')}}"
		style='position:absolute; bottom:1.3%; left:2.5%; width:8.5%; '>
		<div id='VRDataBOX'>
			<div id='VRDataHOLDO'>
	...
	<div id='eMainHORIZONTAL'>
		...
		<img src="{{ asset($mosque->logo ? 'uploads/mosque_logos/' . $mosque->logo : 'assets/logo.png') }}" id="HR_LOGO" alt="app-logo" class="HR_LOGO1" />
	...
	<button id='BtnAudio' onclick='forceAudio();'>
		Azan Voice is Activated in Settings <br> Click Here To Enable Sounds in Browser
	</button>
	<div id='eHELPSCREEN' class='cssHelpSCREEN cssColorLITE'>
		<div align='center' class='cssSET'>
			<div style='position:absolute; right:5%; top:35%;'><span onclick="SetScroll('eMenuGRP', 0);">&#9650;</span>
		...
		<div id='eMenuGRP' align='right' dir='rtl' class='cssMenuGRP'>
			...
			<div class='cssMenuBTN' dir='ltr' style='text-align:center;'>
				...
				<div style='letter-spacing:0.05em;'>
					...
					<span class='CSS_EN33'
					onclick="window.open('https://www.tawkit.net/contact/', '_blank');">CONTACT</span><br><br>
					<span class='CSS_EN33' >&copy;
					{{ get_section_content('project', 'site_title') }}</span><br>
				</div>
				<br>
			</div>
		</div>
	...
	<div id='e_THEMES' class='cssModelSettingsWINDOW cssColorLITE'>
		<div class='cssTitlesHOLDER'>
			...
			<div class='cssWindowCLOSE'><span onclick="SetScroll('scroTHEMES', 0);">&#9650;</span> &nbsp; <span
				onclick="SetScroll('scroTHEMES', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
			...
			<table align='center' cellpadding='2' cellspacing='0' border='0' width='100%' class=''>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='e24CHECK' class='cssCheckBOX' onchange='Set24OnOff()'> &nbsp; <label
						for='e24CHECK' id='XX_OPTION_0'> </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
				...
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eBigIQAMA' class='cssCheckBOX' onchange='SetIqamaBIG()'> &nbsp;
						<label for='eBigIQAMA' id='XX_BIGIQAMA'>---</label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eIQAMAasHOUR' class='cssCheckBOX' onchange='SetIqamaFullTimes()'>
						&nbsp; <label for='eIQAMAasHOUR' id='XX_IQAMAASHOUR'>---</label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eCOUNTDOWNOnOff' class='cssCheckBOX' onchange='SetCOUNTDOWNOnOff()'>
						&nbsp; <label for='eCOUNTDOWNOnOff' id='W9_eCOUNTDOWNOnOff'>---</label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eCountdownCHECK' class='cssCheckBOX' onchange='SetCounterBIG()'>
						&nbsp; <label for='eCountdownCHECK' id='XX_ADJUST_1'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eArabicDIGITS' class='cssCheckBOX' onchange='SetArabicDIGITSOnOff()'>
						&nbsp; <label for='eArabicDIGITS' id='W9_ARABICDIGITS'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' align='' valign='center'>
						<input type='checkbox' id='eAyatsCHECK' class='cssCheckBOX' onchange='SetAYATSOnOff()'> &nbsp;
						<label for='eAyatsCHECK' id='W9_AYATS_ACTIVE'> --- </label>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td height='20' width='100%' valign='center'>
						<input type='checkbox' id='eVoiceCHECK' class='cssCheckBOX' onchange='SetAudioVoiceOnOff()'>
						&nbsp; <label for='eVoiceCHECK' id='XX_ADJUST_2'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' valign='center'>
						<input type='checkbox' id='eShortAZAN' class='cssCheckBOX' onchange='SetShortAZANOnOff()'>
						&nbsp; <label for='eShortAZAN' id='XX_eShortAZAN'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' valign='center'>
						<input type='checkbox' id='eShortIQAMA' class='cssCheckBOX' onchange='SetShortIQAMAOnOff()'>
						&nbsp; <label for='eShortIQAMA' id='XX_eShortIQAMA'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' valign='center'>
						<input type='checkbox' id='eMoreHourCHECK' class='cssCheckBOX' onchange='Set1MoreHOUR()'> &nbsp;
						<label for='eMoreHourCHECK' id='XX_1MOREHOUR'> --- </label>
					</td>
				</tr>
				<tr>
					<td height='20' width='100%' valign='center'>
						<input type='checkbox' id='eLessHourCHECK' class='cssCheckBOX' onchange='Set1LessHOUR()'> &nbsp;
						<label for='eLessHourCHECK' id='XX_1LESSHOUR'> --- </label>
					</td>
				</tr>
			</table>
			<br><br><br><br>
		...
		<div id='scroBLACKS' class='cssSettingsDATA CSS_X_LANG_DIRECTION'>
			...
			<table align='center' cellpadding='5' cellspacing='0' border='0' width='80%' class='cccTBL1'>
				<tr>
					...
					<td height='20' width='15%' align='left'><button class='cccADJUSTER'
						onclick="goDURATIONminus('MAGHRIB')">-</button>
					</td>
					<td height='20' width='15%' align='left'><button class='cccADJUSTER'
						onclick="goDURATIONcplus('MAGHRIB')">+</button>
					</td>
				</tr>
			</table>
			<table align='center' cellpadding='5' cellspacing='0' border='0' width='80%' class='cccTBL1'>
				<tr>
					...
					<td height='20' width='15%' align='left'><button class='cccADJUSTER'
						onclick="goDURATIONminus('ISHA')">-</button>
					</td>
					<td height='20' width='15%' align='left'><button class='cccADJUSTER'
						onclick="goDURATIONcplus('ISHA')">+</button>
					</td>
				</tr>
			</table>
		</div>
	...
	<div id='e_FOXEN' class='cssModelSettingsWINDOW cssColorLITE'>
		<div class='cssTitlesHOLDER'>
			<div class='cssWindowTITLE'></div>
			<div class='cssWindowCLOSE'><span onclick="SetScroll('scroFOXEN', 0);">&#9650;</span> &nbsp; <span
				onclick="SetScroll('scroFOXEN', 1);">&#9660;</span> &nbsp;&nbsp;&nbsp; <span
				onclick='closeThis(this.parentNode);'>&#10006;</span>
			</div>
		</div>
			...
			<table align='center' cellpadding='3' cellspacing='0' border='0' width='80%'>
				<tr>
					<td height='40' width='50%' align='left' valign='top'>
						<input type='radio' onclick='goFontTHIS(this);' id='Amiri' name='Foxens' value='1.0'><label
						for='Amiri'> Amiri</label><br>
						<input type='radio' onclick='goFontTHIS(this);' id='Andalus' name='Foxens' value='1.0'><label
						for='Andalus'> Andalus</label><br>
						<input type='radio' onclick='goFontTHIS(this);' id='STC' name='Foxens' value='1.0'><label
						for='STC'> STC Regular</label><br>
					</td>
					<td height='40' width='50%' align='left' valign='top'>
						<input type='radio' onclick='goFontTHIS(this);' id='KSA' name='Foxens' value='1.0'><label
						for='KSA'> KSA Regular</label><br>
						<input type='radio' onclick='goFontTHIS(this);' id='Almarai' name='Foxens' value='0.85'><label
						for='Almarai'> Almarai</label><br>
						<input type='radio' onclick='goFontTHIS(this);' id='ArefRuqaa' name='Foxens' value='1.0'><label
						for='ArefRuqaa'> Aref Ruqaa</label><br>
					</td>
				</tr>
			</table>
		</div>
...
<script type='text/javascript' language='javascript'>
    ...
    JS_VRMsqNAME.innerHTML = "{{$mosque->app_name}}";
    JS_HRMsqNAME.innerHTML = "{{$mosque->app_name}}";
    ProcessLANGUAGE();
