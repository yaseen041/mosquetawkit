...
<html>
<head>
	<script type='text/javascript' src="{{ asset('assets/admin/countries.js') }}"></script>
	<script type='text/javascript' src="{{ asset('assets/admin/PrayTimes.js') }}"></script>
	<style type='text/css'>
		@font-face {
			font-family: 'Amiri';
		...
		select {padding:3px;}
		.cssINPUT {padding:5px; font-size:12pt; border:3px solid #503931; width:95%;}
		.cssMONO  {font-family:monospace;}
		.eSans    {font-family:sans-serif;}
		img {vertical-align:middle;}
		a {text-decoration:none; color:black;}
		a:hover {color:#982D27;}
		.silver{color:silver;}
		.fs90{font-size:90%;}
		.fs80{font-size:80%;}
		.cssAR {font-size:110%; color:#982D27; font-family:'Amiri'; direction:rtl;}
	...
	<center>
		<div align='center' style='width:750px; padding:15px 0;' >
			...
			<table align='center' cellpadding='0' cellspacing='3' border='0' width='100%' >
				<tr>
					<td height='40' width='20%' align='right' valign='top'>Country - <span class='cssAR'>البلد</span> :</td>
					<td height='40' width='30%' align='left' valign='top'><select id='mCOUNTRY' name='mCOUNTRY' onchange='uCountryCHANGE(this);' class='cssSelecL' ></select></td>
					<td height='40' width='20%' align='right' valign='top'>City - <span class='cssAR'>المدينة</span> :</td>
					<td height='40' width='30%' align='left' valign='top'><select id='mCITY' onchange='uCityCHANGE(this);' class='cssSelecL' ></select></td>
				</tr>
				<tr>
					...
					<td height='40' width='30%' align='left' valign='top' style='position:relative;' >
						...
						<div id='eCUSTBOX' style='width:300px; padding:3px; background-color:lightyellow; border:1px solid silver; display:none;' >
							Fajr : <span id='custFAJR'>-</span> <span class='cssBLUE' onclick="goGpsSetCustom('FAJR');">» Edit (angle)</span> <br />
							Isha : <span id='custISHA'>-</span> <span class='cssBLUE' onclick="goGpsSetCustom('ISHA');">» Edit (angle-or-minutes)</span>
						</div>
					</td>
					<td height='40' width='20%' align='right' valign='top'>Asr :</td>
					<td height='40' width='30%' align='left' valign='top'><select id='mMADHAB' onchange='uMadhabCHANGE(this);' class='cssSelecL' ></select></td>
				</tr>
			</table>
			...
			<table align='center' cellpadding='0' cellspacing='10' border='0' width='100%' >
				<tr>
					<td height='40' width='100%'>
						<div style='padding:25px 0; line-height:43px;' align='center' >
							...
							<span class='cssMONO silver fs80' id='jxREGIO' style='color:orange; cursor:help;' >&nbsp;</span> &nbsp;&nbsp;
							<span style='color:red;' id='jxTODAY' ></span>
						</div>
						<table align='center' cellpadding='3' cellspacing='3' border='0' width='100%' style='background-color:#FFFFE0;text-align:center;' >
							<tr>
						...
						<table align='center' cellpadding='3' cellspacing='3' border='0' width='100%' class='eSans' style='text-align:center;font-size:110%; letter-spacing:1px; background-color:#503931; color:#FFFFE0;' >
							<tr>
				...
				<div align='left' style='color:#919191; width:550px; padding:90px 0px;' >
					Credits : <br />
					Calculation Script of pray times : &nbsp; <a href='http://praytimes.org/' target='_blank' style='color:gray;'>PrayTimes.org</a><br />
					World Geographical Database : &nbsp; <a href='https://www.geonames.org/'  target='_blank' style='color:gray;'>GeoNames.org</a>
					<br>
					<br>
...
/* */
				...
				for (var i=0; i < JS_WORLD_COUNTRIES.length; i++)
				{
					...
					JS_uuuCOUNTRY.append(newOPTO);
	    //if(cntCODE == "SA" ) newOPTO.selected = true;
				}
//--- add also empty item in cities .. for POST !
...
//-----------------------------------------------------------------------------------
			...
			{
JS_uuuCITY.innerHTML = ''; // clear cities
// add empty record
var newOPTO = new Option("", "");
JS_uuuCITY.append(newOPTO);
uCityCHANGE(JS_uuuCITY); // triger
}
//-----------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------
...
var eee_CODE  = tmpARR[0]; // code country
JS_mGPSFULL.innerHTML	= '';
JS_mWTIMES.value	= '';
JS_GPS_CALCULATION_CITIES_NOW = [];
var tempIniFile = "../_online/admin/geoDB/" + eee_CODE + ".js?s="+JS_VERSIO;
...
//JS_mGPSFULL.innerHTML = JS_GPS_FULL_CODE;
JS_jxREGIO.innerHTML  = JS_GPS_FULL_CODE; //arrco[0]+ '.' + arrco[1];
...
{
	var strMORE = "\n\n";
// AD|Onix|42.52828|1.56929|1.0|2.0
	strMORE += "A | B | C | D | E \n\n";
...
/*
"-------------JANUARY-------------------------------",
"01-01~~~~~06:58|08:28|12:52|14:55|17:13|18:43",
JANUARY 02	07:26	09:22	13:46	15:52	18:10	19:55
*/
function makeTable(method, lat, lng, timeZone, dst)
{
	...
	JS_PRAY_TIME.adjust({asr:JS_GPS_ASR_TYPE});
					...
					JS_PRAY_TIME.tune( {fajr:0, sunrise:-7, dhuhr:5, asr:5, maghrib:7, isha:-1} );
					*/
					// MAROC Adjustments ------------------------
	...
	while (JSDate < endDate)
	{
		...
		var tempMONTH  = monthNames[JSNOWMONTH -1];
			// check if as today to show today info
		...
		outDATA += '",\n';
			JSDate.setDate(JSDate.getDate()+ 1);  // Loop For The Next Day
		}
...
function goCalc()
{
// SA|Makkah|21.42664|39.82563|3.0
/// !!!!!!!!!!! IMPORTANT  here we dont use summer time ! so we use time zone ( no summertime in calculation here)
...
goFillMadhabAndMETHODS();
updateGpsCustoms();
//JS_GPS_FULL_CODE = 'SA|Makkah|21.42664|39.82563|3.0|3.0';
