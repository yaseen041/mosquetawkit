...
<head>
  ...
  <title>{{ get_section_content('project', 'site_title') }} Installation for Android Devices &#8211; {{ get_section_content('project', 'site_title') }}</title>
  <link rel='shortcut icon' type='image/x-icon' href="{{ asset('assets/favicon.ico') }}" />
  <link rel='apple-touch-icon' sizes='152x152' href="{{ asset('assets/favicon152.png') }}" />
  <meta name='description' content="{{ get_section_content('project', 'site_title') }} - Awkat Salat Clock | Prayer times for Mosque">
  ...
  <link href="{{ asset('assets/w9vendors/boxicons.min.css') }}" rel='stylesheet'>
  <link href="{{ asset('assets/w9vendors/glightbox.min.css') }}" rel='stylesheet'>
  <link href="{{ asset('assets/w9vendors/swiper-bundle.min.css') }}" rel='stylesheet'>
  <link href="{{ asset('assets/w9style.css') }}" rel='stylesheet'>
  <meta property='og:site_name' content='{{ get_section_content('project', 'site_title') }}'>
  <meta property='og:title' content="{{ get_section_content('project', 'site_title') }} Installation for Android Devices">
  <meta property='og:description' content="{{ get_section_content('project', 'site_title') }} - Awkat Salat Clock | Prayer times for Mosque">
  <meta property='og:image' content='w9images/tawkit_b.jpg'>
  <meta property='og:url' content='https://www.tawkit.net'>
  <meta property='og:type' content='website'>
  <meta property='og:locale:alternate' content='en'>
  <meta name='twitter:card' content='summary'>
  <meta name='twitter:site' content='{{ get_section_content('project', 'site_title') }}'>
  <meta name='twitter:title' content="{{ get_section_content('project', 'site_title') }} Installation for Android Devices">
  <meta name='twitter:description' content="{{ get_section_content('project', 'site_title') }} - Awkat Salat Clock | Prayer times for Mosque">
  <meta name='twitter:image' content='w9images/tawkit_b.jpg'>
</head>
<body>
  <!-- ======= Header ======= -->
  <header id='header'>
    <div class='container d-flex align-items-center justify-content-between'>
      <div class='logo'>
        <h1><a href='/'>{{ get_section_content('project', 'site_title') }}</a></h1>
      </div>
      <nav id='navbar' class='navbar'>
        <ul>
          <li><a class='nav-link scrollto' title='{{ get_section_content('project', 'site_title') }} Online App Administration' href="{{url('admin')}}" target='_blank' >ADMINISTRATION</a></li>
          <li><a class='nav-link scrollto' title='{{ get_section_content('project', 'site_title') }} Live App' href="{{ url('online') }}" target='_blank'>LIVE APP</a></li>
          <li><a class='nav-link scrollto' title='{{ get_section_content('project', 'site_title') }} Installation' href='installation/'>ANDROID INSTALLATION</a></li>
          <li><a class='nav-link scrollto' title='Installers' href='#Installers'>INSTALLERS</a></li>
      ...
      <div class='container'>
        <div class='row content align-items-start'>
          ...
          <div class='col-md-8' >
            ...
            <ul>
              <li><i class='bi bi-check'></i> You need <a href='https://www.google.com/search?q=android+media+box' target='_blank'>Android Media-Box</a> with android version 9 or less !
                <li><i class='bi bi-check'></i> Install <a href='files/opera51.apk'>Opera-Browser</a>.
                  <li><i class='bi bi-check'></i> Install <a href='files/ES-Explorer.apk'>ES-Explorer</a>
                    ...
                    <li><i class='bi bi-check'></i> Download <a href='#'>{{ get_section_content('project', 'site_title') }}</a> in Downloads folder of your device.
                      <li><i class='bi bi-check'></i> Open ES-Explorer and go to Downloads.
                        <li><i class='bi bi-check'></i> Open mosque.zip you downloaded, and click on Extract.
                         ...
                         <p>
                          ...
                          . enter this adress in your browser :  <a href='#' target='_blank'>{{ get_section_content('project', 'site_title') }}</a><br>
                          . or contact an <a href='#Installers' >Installer</a> to help you,<br>
                          . or <a href='contact/' >contact author</a> with more details.
                        </p>
                      </div>
                      <div class='col-md-4' >
                      </div>
                      <div class='col-md-8' >
                        <p class='fst-italic'>
                          ...
                          contact one of <a href='#' >The Installers</a> in your country to help you install {{ get_section_content('project', 'site_title') }}.<br>
                          <br><br><br>
                        </p>
                      </div>
                    </div>
                  ...
                  <div class='container'>
                    <div class='row align-items-end' style='padding-top:35px; border-top:1px solid #F3F3F3;'>
                      <div class='col-lg-4 col-md-4 footer-links'>
                        <ul>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Home Page' href='#'>Home</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Installation on Android Devices' href='#'>Installation</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Frequently Asked Questions' href='#'>F.A.Q</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Live Demonstration' href='#' target='_blank'>{{ get_section_content('project', 'site_title') }} Live Demo</a></li>
                        </ul>
                      </div>
                      <div class='col-lg-4 col-md-4 footer-links'>
                        <ul>
                          <li><i class='bx bx-chevron-right'></i> <a title='Contact {{ get_section_content('project', 'site_title') }} Author' href='#'>Contact Author</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Offline App Installers' href='#' >Installers</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Online App Administration' href='#' target='_blank' >Online Administration</a></li>
                          <li><i class='bx bx-chevron-right'></i> <a title='{{ get_section_content('project', 'site_title') }} Annual Prayer Times File Maker' href='#'>{{ get_section_content('project', 'site_title') }} wTimes File Maker</a></li>
                        </ul>
                      </div>
                      <div class='col-lg-4 col-md-4 footer-links'>
                        <ul align='right'>
...
//-----------------------------------------------------------------------------------
//var JS_SCR_X = document.getElementById('scr-x');
//var JS_SCR_0 = document.getElementById('scr-0');
...
//-----------------------------------------------------------------------------------
//setInterval('PlayScreens()',5000 );
//setTimeout(RandomScreenNOW, 1000);
            </script>
          </body>
          </html>