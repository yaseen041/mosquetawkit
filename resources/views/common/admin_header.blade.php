...
<link href="{{ asset('admin_assets/ccs/plugins/dropzone/basic.css') }}" rel="stylesheet">
<link href="{{ asset('admin_assets/css/plugins/dropzone/dropzone.css') }}" rel="stylesheet">
...
<link href="{{ asset('admin_assets/css/plugins/switchery/switchery.css') }}" rel="stylesheet">
